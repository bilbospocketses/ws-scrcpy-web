...
- **Wireless-debugging QR pairing** -- pair Android from the browser using the standard QR flow on the same LAN, or a Tailscale `100.x` address when mDNS is not routable.
