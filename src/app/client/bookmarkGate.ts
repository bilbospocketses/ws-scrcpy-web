/**
 * Decide whether to show the "bookmark this URL" reminder card. Pure (no DOM) so
 * it is unit-testable and importable by the entry point without pulling the
 * BookmarkReminder bundle into the entry chunk.
 *
